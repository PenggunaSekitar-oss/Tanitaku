export function ModuleSkeleton() {
  return (
    <div className="animate-pulse space-y-5" aria-label="Memuat modul">
...
export function WeatherSkeleton() {
  return (
    <div className="grid animate-pulse gap-4 p-4 sm:p-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(300px,0.65fr)]" aria-label="Memuat prakiraan cuaca">
